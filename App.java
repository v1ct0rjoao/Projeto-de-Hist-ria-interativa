...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Capitulos Cap1 = new Capitulos("Finalmente Ferias",
                ...
                "voce fala para eles que nao deviam ir ate la",
                "Mesmo eles rindo de você, você volta pra casa e não desobedeci seu avô");

        Capitulos Cap2 = new Capitulos("Brincadeira de Criança",
                ...
                "voce tenta ler os papeis", "Abre a porta da casinha" );

        Capitulos Cap3 = new Capitulos("Eles Sabem de algo",
                "Você tenta ler os papéis apregados na porta, derepente você\n" + // resposta a do cap 2
                        ...
                        +
                        "como se soubessem de algo...",rafa, -50,
                "", "");

        Capitulos Cap4 = new Capitulos("Coragem",
                "Quando você abre a porta todos ficam felizes com sua coragem e entram vasculhando\n" +
                        ...
                        "passar o tempo...\n\n", marcos, -10,
                "joga com eles", "decidi que é loucura e vai dormir");

        Capitulos Cap5 = new Capitulos("Arrepemdimento",
                "vocês começam a jogar e perguntam se tem alguma presença no local\n" +
                        ...
                        + "VOCÊS VÃO MORREEER!!!!!", Joao, -50,
                "", "");

        Capitulos Cap6 = new Capitulos("O Espirito se revelou",
                "Você tem medo de coisas que falam de espiritos, porque acha que eles vão puxar o seu pé\n" +
                        ...
                        +
                        "achando que seu avó tinha matado seu primos...",Joao, -50,
                "", "");
        ...
        if (resposta.equals(Cap1.escolha1)) {
            Cap2.mostrar();
            resposta = leitor.nextLine();

            if (resposta.equals(Cap2.escolha1)) {

                Cap3.mostrar();
            }

            if (resposta.equals(Cap2.escolha2)) {
                Cap4.mostrar();
                resposta = leitor.nextLine();
            }
            if (resposta.equals(Cap4.escolha1)) {
                Cap5.mostrar();
            }

            if (resposta.equals(Cap4.escolha2)) {
                Cap6.mostrar();
                System.out.println("\n\no unico sobrevivente foi Joao");
            }

        } else if (resposta.equals(Cap1.escolha2)) {
            Cap6.mostrar();
